    ...
    <div className="flex min-h-screen bg-gray-50 font-sans">
      ...
      <aside className="w-56 bg-[#1e1b2e] text-white flex flex-col fixed top-0 left-0 h-full z-50 py-6 px-4">
        ...
        <nav className="flex flex-col gap-1 flex-1">
          <button onClick={() => navigate("/admin/dashboard")} className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-purple-300 hover:bg-purple-600/20 hover:text-white text-sm font-medium text-left">🚀 Projects</button>
          <button onClick={() => navigate("/admin/dashboard")} className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-purple-300 hover:bg-purple-600/20 hover:text-white text-sm font-medium text-left">⚙️ Services</button>
          <button className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-purple-600/40 text-white text-sm font-medium text-left">🎠 Carousel</button>
        </nav>
