    ...
    <div className="min-h-screen flex flex-col bg-background relative selection:bg-primary/30 overflow-x-hidden transition-colors duration-300">
      ...
      <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[200] flex flex-col gap-2 md:gap-3 items-center">
        ...
        <a
          ...
          className="group relative w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-transform duration-300"
        ...
        >
          ...
          <span className="absolute right-14 md:right-16 top-1/2 -translate-y-1/2 bg-[#25D366] text-white text-xs font-bold px-3 py-1 rounded-full whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-md pointer-events-none hidden md:block">
            WhatsApp Us
          </span>
        </a>
        ...
        >
          ...
          <span className="absolute right-14 md:right-16 top-1/2 -translate-y-1/2 bg-[#E53935] text-white text-xs font-bold px-3 py-1 rounded-full whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-md pointer-events-none hidden md:block">
            Call Us
          </span>
        </a>
      </div>
